...
// AXIOS
import {axiosPatientOxygenDetailGetRequest} from '../../api/axios_requests.js';
...
const PatientOxygenDetailsScreen = () => {
  ...
  const handleGetPatientDetails = async () => {
    if (uuid !== null) {
      try {
        const response = await axiosPatientOxygenDetailGetRequest(
          accessToken,
          uuid,
        );
      ...
      {isLoadingScreen ? (
        ...
        <View style={{...styles.bodyWrapper}}>
          ...
          <View style={{...styles.detailsWrapper}}>
            ...
            <View style={{...styles.detailsLog}}>
              <Text style={{...sy.smRgStTxt}}>Oxygen cylinders required</Text>
              <Text style={{...sy.smRgTTxt}}>{resData.quantity}</Text>
            </View>
            <View style={{...styles.detailsLog}}>
          ...
          <View style={{...styles.detailsWrapper}}>
            ...
            <View style={{...styles.detailsLog}}>
              ...
              <Text style={{...sy.smRgTTxt}}>{resData.patient.mobile}</Text>
            </View>
            <View style={{...styles.detailsLog}}>
              <Text style={{...sy.smRgStTxt}}>Location</Text>
              <Text style={{...sy.smRgTTxt}}>{resData.oxygen_location}</Text>
            </View>
          </View>
          <View style={{...styles.actionWrapper}}>
            ...
            <MdBtn
              title="Call"
              onPress={() => {
                dialPatientContact(resData.patient.mobile);
              }}
            />
          </View>
...
export default PatientOxygenDetailsScreen;
